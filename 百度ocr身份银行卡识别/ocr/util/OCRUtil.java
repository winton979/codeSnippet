package com.pricl.biz.ocr.util;
...
public class OCRUtil {
     ...
     * @throws OCRException
     */
    public static IdentityInfo getIdentityInfo(org.json.JSONObject resultJson) {
        JSONObject object = convert(resultJson);
        if (object.containsKey("error_code")) {
            String code = object.get("error_code").toString();
            throw new E(-1, getErrorMsg(code));
        }
     ...
     * @throws OCRException
     */
    public static BankCardInfo getBankCardInfo(org.json.JSONObject resultJson) {
        JSONObject object = convert(resultJson);
        if (object.containsKey("error_code")) {
            String code = object.get("error_code").toString();
            throw new E(-1, getErrorMsg(code));
